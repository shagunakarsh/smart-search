...
#url = "file:///home/shagun/Desktop/gsfhack/a.html"
url = "localhost/abcd.html"
#myuser = 'shagun'
#mypass = getpass.getpass()

#authrequest = request.post(url,data=dict(j_username=myuser, j_password=base64.b64encode(mypass),ajax=1)
#cookies = authrequest.cookies.get_dict()
